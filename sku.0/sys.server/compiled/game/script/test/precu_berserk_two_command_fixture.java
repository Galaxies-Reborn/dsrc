...
/** Identity-bound reversible fixture for the Publish 14.1 berserk2 command. */
public class precu_berserk_two_command_fixture extends script.base_script
{
    private static final long PLAYER_OID = 44003778L;
    private static final int PLAYER_STATION_ID = 91001;
    private static final int PROTOCOL_VERSION = 1;
    private static final String COMMAND = "berserk2";
    private static final String ROOT = "precu.b2Fixture";
        ...
        throws InterruptedException
    {
        ...
        if (hasAnyFixtureSkill(player) || hasCommand(player, COMMAND) ||
            getSkillStatMod(player, "berserk") != 0 ||
        ...
        if (getSkillStatMod(player, "berserk") != 20 ||
