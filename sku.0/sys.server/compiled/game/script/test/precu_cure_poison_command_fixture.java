...
/**
 * Identity-bound and reversible fixture for Publish 14.1 Cure Poison.
 *
 * The fixture owns one private poison DOT, one two-charge antidote, and the
 * exact Medic-through-Doctor-Wound-Speed-II skill chain. The connected client
 * remains the sole command-admission owner.
 */
public class precu_cure_poison_command_fixture
    extends script.base_script
{
    private static final long PLAYER_OID = 39008597L;
    private static final int PLAYER_STATION_ID = 1001;
    private static final String COMMAND = "curePoison";
    private static final String DOT_ID =
        "precu_cure_poison_fixture";
    private static final int POISON_STRENGTH = 90;
    ...
    private static final String ROOT =
        "precu.curePoisonCommandFixture";
    ...
    private static final String BEFORE_CHARGES =
        ROOT + ".beforeCharges";
    private static final String BEFORE_POISON =
        ROOT + ".beforePoison";
        ...
        throws InterruptedException
    {
        ...
        if (dot.isPoisoned(player))
        {
            return "error=existingPoison";
        }
            ...
            getCount(medicine) != 2)
        {
            boolean restored = restore(player);
            return
                "error=poisonPreparationFailed restored=" +
                restored;
        }
        setObjVar(
            player,
        ...
        throws InterruptedException
    {
        ...
        return
            ...
            " appliedPoisonBefore=" +
                readInt(player, ".poisonBefore") +
            " appliedPoisonAfter=" +
                readInt(player, ".poisonAfter") +
            " appliedPoisonReduction=" +
                readInt(player, ".poisonReduction") +
            " appliedMindCost=" +
    ...
    private int getPoisonStrength(obj_id player)
        throws InterruptedException
    {
        String[] poison =
            dot.getAllDotsType(
