...
/**
 * Identity-bound and reversible fixture for Publish 14.1 Cure Disease.
 *
 * The fixture owns one private disease DOT, one two-charge antidote, and the
 * exact Medic-through-Doctor-Wound-Speed-IV skill chain. The connected client
 * remains the sole command-admission owner.
 */
public class precu_cure_disease_command_fixture
    extends script.base_script
{
    private static final long PLAYER_OID = 39008597L;
    private static final int PLAYER_STATION_ID = 1001;
    private static final String COMMAND = "cureDisease";
    private static final String DOT_ID =
        "precu_cure_disease_fixture";
    private static final int DISEASE_STRENGTH = 90;
    ...
    private static final String BEFORE_CHARGES =
        ROOT + ".beforeCharges";
    private static final String BEFORE_DISEASE =
        ROOT + ".beforeDisease";
        ...
        throws InterruptedException
    {
        ...
        if (dot.isDiseased(player))
        {
            return "error=existingDisease";
        }
            ...
            getCount(medicine) != 2)
        {
            boolean restored = restore(player);
            return
                "error=diseasePreparationFailed restored=" +
                restored;
        }
        setObjVar(
            player,
        ...
        throws InterruptedException
    {
        ...
        return
            ...
            " appliedDiseaseBefore=" +
                readInt(player, ".diseaseBefore") +
            " appliedDiseaseAfter=" +
                readInt(player, ".diseaseAfter") +
            " appliedDiseaseReduction=" +
                readInt(player, ".diseaseReduction") +
            " appliedMindCost=" +
    ...
    private int getDiseaseStrength(obj_id player)
        throws InterruptedException
    {
        String[] disease =
            dot.getAllDotsType(
